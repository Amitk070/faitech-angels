      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Faith Technology (Faith Tech) represents the convergence of spiritual practices, religious services, 
        ...
        <div className="bg-gradient-to-r from-orange-50 to-white p-8 rounded-xl">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              ...
              Faith Tech startups are revolutionizing how Indians connect with their spiritual roots.
            </p>
